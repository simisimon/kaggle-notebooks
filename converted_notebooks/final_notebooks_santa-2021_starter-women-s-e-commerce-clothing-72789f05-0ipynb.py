...
# ### Let's check 1st file: /kaggle/input/Womens Clothing E-Commerce Reviews.csv
...
df1 = pd.read_csv('/kaggle/input/Womens Clothing E-Commerce Reviews.csv', delimiter=',', nrows = nRowsRead)
