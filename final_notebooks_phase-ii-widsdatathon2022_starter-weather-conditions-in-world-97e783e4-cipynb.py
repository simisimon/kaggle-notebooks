...
# ### Let's check 1st file: ../input/Summary of Weather.csv
...
df1 = pd.read_csv('../input/Summary of Weather.csv', delimiter=',', nrows = nRowsRead)
...
# ### Let's check 2nd file: ../input/Weather Station Locations.csv

# In[ ]:


nRowsRead = 1000 # specify 'None' if want to read whole file
df2 = pd.read_csv('../input/Weather Station Locations.csv', delimiter=',', nrows = nRowsRead)
