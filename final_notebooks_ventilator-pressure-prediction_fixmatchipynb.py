...
def get_confusion_matrix(test_dataset, device):
...
def main():
    ...
    parser.add_argument('--dataset', default='oxfordiiit', type=str,
                        ...
                        help='dataset name')
    parser.add_argument('--num-labeled', type=int, default=999,
    ...
    parser.add_argument('--eval-step', default=2**6, type=int,
    ...
    get_confusion_matrix(test_loader, args.device)
...
base_dataset = datasets.OxfordIIITPet('oxford', split='test', download=True)
...
df = pd.DataFrame(base_dataset._images)


# In[ ]:


df = np.array(base_dataset.__getitem__(0)[0])
